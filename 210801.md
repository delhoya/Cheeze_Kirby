...
+ 구글 코랩 (ipynb) and 로컬 (py) ang 깃허브(git)
...
+ 부동소수점
  + 1.23 = 123 * 10^-2 (3가지의 정보가 필요 / 123 : 가수, 2:지수, +- : 부호)
  + 가수: 표현 할 수있는 수의 범위  / 지수 : 정밀도 측정 
  + 예시 : 0.1 * 0.1 = 0.0100000000002 (신경망의 연결가중치 부동소수점 문제 유의할것) 
